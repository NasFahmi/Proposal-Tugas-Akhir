...
\singlespacing      % spasi 1.0
\onehalfspacing     % spasi 1.5
\doublespacing      % spasi 2.0
...
\makeatletter
% Halaman kosong dengan nomor halaman (plain)
...
% Halaman kosong TANPA nomor halaman (empty)
\newcommand{\halamankosongempty}{%
  \clearpage
  \ifodd\c@page
  \else
    \thispagestyle{empty}
...
% Atur paragraf untuk justify tanpa hyphenation
\setlength{\RaggedRightRightskip}{\fill}
\setlength{\RaggedRightParfillskip}{\fill}
